...
// gau_blur filter Memory Map
// Used between SimpleBus & GauFilter
const int Gau_MM_BASE = 0x90000000;
const int Gau_MM_SIZE = 0x00000008;
const int Gau_MM_MASK = 0x00000007;
